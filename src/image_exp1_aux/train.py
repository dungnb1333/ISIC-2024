...
parser.add_argument("--cfg", default='configs/vit_256.yaml', type=str)
...
if __name__ == "__main__":
    ...
    df = df.merge(mask_df, on = 'image_path', how = 'left')
    ...
    for fold in args.folds:
        ...
        LOG = '{}/{}_{}_aux_fold{}.log'.format(args.ckpt_dir, cfg['model_name'], cfg['image_size'], fold)
        CHECKPOINT = '{}/{}_{}_aux_fold{}.pt'.format(args.ckpt_dir, cfg['model_name'], cfg['image_size'], fold)
