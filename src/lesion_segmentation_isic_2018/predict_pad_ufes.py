...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('../../dataset/PAD-UFES-20/train_kfold.csv')
    ...
    mask_dir = '../../dataset/PAD-UFES-20/mask_256'
    ...
    new_df.to_csv('../../dataset/PAD-UFES-20/PAD-UFES-20_mask.csv', index=False)
