...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('../../dataset/isic_2020/train_kfold.csv')
    ...
    mask_dir = '../../dataset/isic_2020/mask_256'
    ...
    new_df.to_csv('../../dataset/isic_2020/isic_2020_mask.csv', index=False)
