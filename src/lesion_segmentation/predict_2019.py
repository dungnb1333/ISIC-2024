...
if __name__ == "__main__":
    ...
    test_df = pd.read_csv('../../dataset/isic_2019/train_kfold.csv')
    ...
    mask_dir = '../../dataset/isic_2019/mask_256'
    ...
    new_df.to_csv('../../dataset/isic_2019/isic_2019_mask.csv', index=False)
